...
| `foldkit_get_runtime_diagnostics` | Lists Subscription and ManagedResource lifecycle facts plus terminal Update, Command, Subscription, and ManagedResource failures from the shared Program runtime.                                                                                                                                                                                                                                                                                                                                         |
