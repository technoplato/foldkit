...
export const routeToUrlPath = (route: AppRoute): string =>
  M.value(route).pipe(
    ...
    M.tagsExhaustive({
      ...
      CoreCounterExample: () => coreCounterExampleRouter.build({}),
      CoreModel: () => coreModelRouter.build({}),
      CoreMessages: () => coreMessagesRouter.build({}),
      CoreUpdate: () => coreUpdateRouter.build({}),
      CoreView: () => coreViewRouter.build({}),
      CoreCommands: () => coreCommandsRouter.build({}),
      CoreSubscriptions: () => coreSubscriptionsRouter.build({}),
      CoreInit: () => coreInitRouter.build({}),
      CoreTask: () => coreTaskRouter.build({}),
      CoreRunningYourApp: () => coreRunningYourAppRouter.build({}),
      CoreResources: () => coreResourcesRouter.build({}),
      CoreManagedResources: () =>
        coreManagedResourcesRouter.build({}),
      CoreErrorView: () => coreErrorViewRouter.build({}),
      CoreSlowViewWarning: () => coreSlowViewWarningRouter.build({}),
      PatternsSubmodels: () => patternsSubmodelsRouter.build({}),
      PatternsModelAsUnion: () =>
        patternsModelAsUnionRouter.build({}),
      PatternsOutMessage: () => patternsOutMessageRouter.build({}),
      CoreViewMemoization: () => coreViewMemoizationRouter.build({}),
      UiTabs: () => uiTabsRouter.build({}),
      UiDisclosure: () => uiDisclosureRouter.build({}),
      UiDialog: () => uiDialogRouter.build({}),
      UiMenu: () => uiMenuRouter.build({}),
      UiPopover: () => uiPopoverRouter.build({}),
      UiListbox: () => uiListboxRouter.build({}),
      UiSwitch: () => uiSwitchRouter.build({}),
      UiCombobox: () => uiComboboxRouter.build({}),
