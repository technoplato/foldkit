  ...
  return h.div(
    ...
    [
      ...
      para(
        ...
        ' (Listbox and Combobox), which mirrors an external value (a URL parameter, restored storage, a server push) onto the selection without emitting an OutMessage. See ',
        link(
