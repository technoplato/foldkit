...
export const tableOfContents: ReadonlyArray<TableOfContentsEntry> = [
  { level: 'h2', ...theProblemHeader },
  { level: 'h2', ...foldkitVsReactHeader },
  { level: 'h2', ...theElmArchitectureHeader },
  { level: 'h2', ...builtOnEffectHeader },
  { level: 'h2', ...whoItsForHeader },
]
...
export const view = (): Html =>
  div(
    [],
    [
      heading(1, 'whyFoldkit', 'Why Foldkit?'),
      section(theProblemHeader.id, theProblemHeader.text, [
        para(
      ...
      section(foldkitVsReactHeader.id, foldkitVsReactHeader.text, [
        para(
      ...
      section(
        theElmArchitectureHeader.id,
        theElmArchitectureHeader.text,
        [
          para(
            'Foldkit implements ',
      ...
      section(builtOnEffectHeader.id, builtOnEffectHeader.text, [
        para(
          'Foldkit is built on ',
      ...
      section(whoItsForHeader.id, whoItsForHeader.text, [
        ul(
          [Class('list-disc mb-6 space-y-2 ml-4')],
          [
            li(
