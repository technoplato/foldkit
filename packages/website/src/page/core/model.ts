  ...
  return h.div(
    ...
    [
      ...
      highlightedCodeBlock(
        h.div(
          [h.Class('text-sm'), h.InnerHTML(Snippet.counterModelHighlighted)],
          [],
        ),
        Snippet.counterModelRaw,
      ...
      highlightedCodeBlock(
        h.div(
          [
            h.Class('text-sm'),
            h.InnerHTML(Snippet.counterModelPreviewHighlighted),
          ],
          [],
        ),
        Snippet.counterModelPreviewRaw,
