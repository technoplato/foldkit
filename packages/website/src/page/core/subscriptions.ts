  ...
  h.div(
    ...
    [
      ...
      para(
        ...
        inlineCode('update'),
        ' would arrive after the browser had committed the default. For these cases, do the DOM mutation inside ',
        inlineCode('Stream.mapEffect'),
        ' so it runs in the same call stack as the browser’s event dispatch.',
      ),
      para(
        'In the ',
        link(
