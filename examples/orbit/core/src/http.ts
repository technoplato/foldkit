...
export const orbitTools: ReadonlyArray<OrbitTool> = [
  ...
  },
  {
    ...
    mentionedIn:
      'Voice memos + photos + screen actions, one scrubbable timeline.',
  },
  {
    id: 'wait-inspector',
    number: '03',
  ...
  },
  {
    ...
    mentionedIn:
      'Machine-public schema. One script. No agent required after fire.',
  },
  {
    id: 'leaderboard',
    number: '05',
  ...
  },
  {
    ...
    mentionedIn:
      'Every message is inspected. Rules start fixed and then evolve.',
  },
  {
    id: 'reverse-refs',
    number: '08',
  ...
  },
  {
    ...
    tagline:
      'Solve. Then 10× fewer. Then 10× again — or comments a weaker model can rebuild.',
    status: 'runnable',
    filename: 'ladder.ts',
    language: 'ts',
    instructions: [
  ...
  },
  {
    ...
    name: 'FoldKit / TCA',
    tagline:
      'Two stacks. Same core. Many clients. That is the other challenge.',
    status: 'runnable',
    filename: 'stacks.ts',
    language: 'ts',
    instructions: [
  ...
  },
  {
    ...
    name: 'Sim Wallet',
    tagline:
      'FoldKit ADTs for play credits. Danger is data. Live is not a type.',
    status: 'runnable',
    filename: 'foldkit.ts',
    language: 'ts',
    instructions: [
  ...
  },
  {
    ...
    tagline:
      'Same core. Three.js host. Counters, then a vending machine. That is a degree.',
    status: 'spec',
...
export const foldkitSnapDocument = (origin: string, payload: unknown) => ({
