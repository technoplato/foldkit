...
One Program. Many views. Model impossible states as tagged unions (`foldkit/attention`, `foldkit/spatial`, `foldkit/asyncData`). Do not flatten roam/read/operate into booleans.
