...
export const INDEX_STEPS = [
  ...
  { id: "03", tag: "do", title: "Mint 1428 play to tortoise (14.28 callback, play units)" },
...
export const runIndex = (
  ...
  const apply = (message: Parameters<typeof update>[1]): Outcome | undefined => {
  ...
  const liveRefused =
    o7?._tag === 'refuse' && o7.danger._tag === 'live-wallet'
  ...
  const chainRefused =
    o9?._tag === 'refuse' && o9.danger._tag === 'chain-send'
  ...
  const keyRefused =
    o10?._tag === 'refuse' && o10.danger._tag === 'key-exfil'
