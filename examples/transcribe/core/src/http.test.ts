...
import { createJobRegistry, handleTranscribeRequest, jobFromArtifacts, wordsFromWhisper } from "./http.js"
...
describe("follow-along words", () => {
  ...
  test("GET /jobs JSON includes words and local media", () => {
    ...
    expect(body.words[0]).toEqual({ id: "w0", text: "Okay,", start: 0, end: 0.96 })
