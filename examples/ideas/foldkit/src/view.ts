...
const selectedPanel = (model: Model): Html => {
  ...
  return h.article(
    ...
    [
      ...
      h.h2(
        [h.Class('mt-2 text-2xl font-semibold text-stone-900')],
        [idea.title],
      ),
  ...
  return h.div(
    ...
    [
      h.main(
        [
          h.Class(
            'mx-auto grid max-w-5xl gap-8 p-8 lg:grid-cols-[1.2fr_0.8fr]',
          ),
        ],
        [
          h.section(
            ...
            [
              ...
              h.h1([h.Class('text-3xl font-semibold')], ['Public notes']),
