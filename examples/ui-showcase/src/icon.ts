...
export const chevronDown = <ParentMessage>(
  ...
  heroIcon<ParentMessage>(className, '1.5', 'M19.5 8.25l-7.5 7.5-7.5-7.5')

export const chevronLeft = <ParentMessage>(
  className: string = 'w-6 h-6',
): Html =>
  heroIcon<ParentMessage>(className, '1.5', 'M15.75 19.5L8.25 12l7.5-7.5')

export const chevronRight = <ParentMessage>(
  className: string = 'w-6 h-6',
): Html =>
  heroIcon<ParentMessage>(className, '1.5', 'm8.25 4.5 7.5 7.5-7.5 7.5')

export const check = <ParentMessage>(className: string = 'w-6 h-6'): Html =>
  heroIcon<ParentMessage>(className, '2', 'M4.5 12.75l6 6 9-13.5')

export const pencil = <ParentMessage>(className: string = 'w-5 h-5'): Html =>
  heroIcon<ParentMessage>(
    className,
    '1.5',
...
export const documentDuplicate = <ParentMessage>(
...
export const archiveBox = <ParentMessage>(
  className: string = 'w-5 h-5',
): Html =>
  heroIcon<ParentMessage>(
    className,
...
export const arrowRight = <ParentMessage>(
  className: string = 'w-5 h-5',
): Html =>
  heroIcon<ParentMessage>(
    className,
...
export const trash = <ParentMessage>(className: string = 'w-5 h-5'): Html =>
  heroIcon<ParentMessage>(
    className,
    '1.5',
...
export const menu = <ParentMessage>(className: string = 'w-6 h-6'): Html =>
  heroIcon<ParentMessage>(
    className,
    '1.5',
...
export const xMark = <ParentMessage>(className: string = 'w-6 h-6'): Html =>
  heroIcon<ParentMessage>(className, '1.5', 'M6 18 18 6M6 6l12 12')
