...
/** Starts one long-lived Gate Processor. First paint is Reading. */
export const createGateHandle = (
  resources: Layer.Layer<GateOrigin> = GateOriginHttpLive,
...
const hooks = createProgramHooks<Model, Message, Actions>(Path(), {
  ...
  toScreen: synced => gateScreen(productOf(synced)),
...
/** Installs a Gate handle. Tests use this. The window does not. */
export const installGateHandle = (
...
export const resetScreenGateHandle = (): void => {
